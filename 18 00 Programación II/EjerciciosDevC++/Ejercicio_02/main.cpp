...
int main(int argc, char const *argv[])
{
    ...
    while (salir == false)
    {
        string buscar = "";
        system("cls");
        cout << "Ingrese la descripcion o el autor del libro que desea encontrar: ";
        cin >> buscar;
        ...
        for (int i = 0; i < 39; i++)
        {
            ...
            transform(buscar.begin(), buscar.end(), buscar.begin(), ::tolower);
             ...
             if (libroEnminuscula.find(buscar) != string::npos || autorEnminuscula.find(buscar) != string::npos )  {
                cout << "Descripcion o autor(a) del libro encontrado: " << libro << endl;
        ...
        if (salir == false) {
            ...
            while(true) {
                system("cls");
                cout << "No se encontro el libro o el autor que busca. Desea continuar? s/n ";
                cin >> continuar;
